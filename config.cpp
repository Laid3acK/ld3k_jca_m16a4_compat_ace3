...
class CfgAmmo
{
    ...
    class JCA_B_556x45_Ball: BulletBase // M855, ACE3 https://github.com/acemod/ACE3/blob/master/addons/ballistics/CfgAmmo.hpp#L117
    {
        ...
        ACE_muzzleVelocities[]={723,792,840,881,898,920,934}; // Muzzle Velocities shift +8m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 926m/s (20") at 15°C (ICAO: 15°C, 1013.25hPa, 0%) according to JCA_M16 initSpeed
        ACE_barrelLengths[]={203.2,254,304.8,368.3,406.4,457.2,508}; // M16A4 20" (508mm) barrel length
        airLock=1;
    ...
    class JCA_B_556x45_Ball_M855A1: JCA_B_556x45_Ball // M855A1 Lake City Army Ammunition Plant, 2022/23 article https://www.ar15.com/forums/AR-15/M855A1-Accuracy-and-Velocity-updated-/16-783286/
    {
        ...
        ACE_muzzleVelocities[]={734,804,853,894,911,934,948}; // Muzzle Velocities shift +8m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 940m/s (20") at 15°C (ICAO: 15°C, 1013.25hPa, 0%) according to JCA_M16 initSpeed
        ACE_barrelLengths[]={203.2,254,304.8,368.3,406.4,457.2,508}; // M16A4 20" (508mm) barrel length
    ...
    class JCA_B_556x45_Ball_M193: JCA_B_556x45_Ball // M193 RUAG Ammotec AG
    {
        ...
        ACE_standardAtmosphere="ICAO";
        ACE_dragModel=1;
        ACE_muzzleVelocities[]={772,846,898,941,960,983,998}; // Muzzle Velocities shift +8m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 990m/s (20") at 15°C (ICAO: 15°C, 1013.25hPa, 0%) according to JCA_M16 initSpeed
        ACE_barrelLengths[]={203.2,254,304.8,368.3,406.4,457.2,508}; // M16A4 20" (508mm) barrel length
    ...
    class JCA_B_556x45_Ball_Mk262: JCA_B_556x45_Ball // ACE_556x45_Ball_Mk262 https://github.com/acemod/ACE3/blob/master/addons/ballistics/CfgAmmo.hpp#L141
    {
        ...
        ACE_standardAtmosphere="ICAO";
        ACE_dragModel=1;
        ACE_muzzleVelocities[]={655,717,761,798,813,833,846}; // Muzzle Velocities shift +8m/s at 70°F (21°C), 838m/s (20") at 15°C (ICAO: 15°C, 1013.25hPa, 0%) according to JCA_M16 initSpeed
        ACE_barrelLengths[]={203.2,254,304.8,368.3,406.4,457.2,508}; // M16A4 20" (508mm) barrel length
    ...
    class JCA_B_556x45_Ball_Mk318: JCA_B_556x45_Ball // ACE_556x45_Ball_Mk318 https://github.com/acemod/ACE3/blob/master/addons/ballistics/CfgAmmo.hpp#L155
    {
        ...
        ACE_standardAtmosphere="ICAO";
        ACE_dragModel=1;
        ACE_muzzleVelocities[]={742,812,862,904,921,944,958}; // Muzzle Velocities shift +8m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 950m/s (20") at 15°C (ICAO: 15°C, 1013.25hPa, 0%) according to JCA_M16 initSpeed
        ACE_barrelLengths[]={203.2,254,304.8,368.3,406.4,457.2,508}; // M16A4 20" (508mm) barrel length
    ...
    class JCA_B_556x45_Ball_M995AP: JCA_B_556x45_Ball // ACE_556x45_Ball_M995_AP https://github.com/acemod/ACE3/blob/master/addons/ballistics/CfgAmmo.hpp#L168
    {
        ...
        ACE_standardAtmosphere="ICAO";
        ACE_dragModel=1;
        ACE_muzzleVelocities[]={687,753,799,838,854,875,888}; // Muzzle Velocities shift +8m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 880m/s (20") at 15°C (ICAO: 15°C, 1013.25hPa, 0%) according to JCA_M16 initSpeed
        ACE_barrelLengths[]={203.2,254,304.8,368.3,406.4,457.2,508}; // M16A4 20" (508mm) barrel length
        hit=9.3; // 1757 Joules
    ...
    class JCA_B_556x45_Ball_Dual: JCA_B_556x45_Ball // 5.56mm underwater subsonic DSG Technology https://dsgtec.com/ https://www.thefirearmblog.com/blog/2017/04/20/dsg-technology-underwater-ammo/
    {
        ...
        ACE_standardAtmosphere="ICAO";
        ACE_dragModel=7;
        ACE_muzzleVelocities[]={220,241,255,268,273,280,284}; // Muzzle Velocities shift +1m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 283m/s (20") at 15°C (ICAO: 15°C, 1013.25hPa, 0%) according to JCA_M16 initSpeed
        ACE_barrelLengths[]={203.2,254,304.8,368.3,406.4,457.2,508}; // M16A4 20" (508mm) barrel length
        // cartridge="FxCartridge_65";
